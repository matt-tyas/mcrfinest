...
<style type="text/css">
    ...
    #mc_embed_signup .button { background: #886808; font-size: 20px; height: 40px; }
...
<form action="https://ManchestersFinest.us2.list-manage.com/subscribe/post?u=80f2869a6d1828e3a9de6548f&amp;id=3b2131b21e" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
    <div id="mc_embed_signup_scroll">
	<h2>Subscribe to our Newsletter</h2>
    <div class="mc-field-group">
    	<label for="mce-EMAIL" class="accessibility">Email address</label>
	    <input type="email" value="" name="EMAIL" class="required email" id="mce-EMAIL" placeholder="Enter email address">
    </div>
<div class="mc-field-group input-group">
    <input type="radio" value="1" name="group[1]" id="mce-group[1]-1-0" class="newsletter-radio">
    <label for="mce-group[1]-1-0" class="newsletter-radio__label">Also send me exclusive events and news from our favourite venues and brands <div class="check"></div></label>
