				...
				<div class="social-wrap">
					<aside class="social-links is--sticky">
						...
						<ul class="social social-share">
							...
							<!-- <li>
								<a class="btn-circle btn--secondary whatsapp" href="whatsapp://send?text=The text to share!" data-action="share/whatsapp/share" target="_blank" rel="nofollow"><span aria-hidden="true" class="icon-facebook"></span><span class="accessibility">Share article via Whatsapp</span></a>
							</li> -->
							<li>
