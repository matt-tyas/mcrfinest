					...
					<aside class="social-links is--sticky">
						...
						<ul class="social social-share">
							...
							<li class="mobile-only">
								<a class="btn-circle btn--secondary whatsapp" href="whatsapp://send?text=<?php the_permalink(); ?>" data-action="share/whatsapp/share" target="_blank" rel="nofollow"><span aria-hidden="true" class="icon-facebook"></span><span class="accessibility">Share article via Whatsapp</span></a>
							</li>
							<li>
